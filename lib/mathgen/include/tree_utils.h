...
// probs = (const_prob, var_prob, binary_prob, nary_prob);
NodePtr randomTree(unsigned int maxDepth, const std::vector<std::string>& variables, std::tuple<double, double, double, double> probs,
    const UnaryMap& unaryFuncs, const BinaryMap& binaryFuncs, const NaryMap& naryFuncs);
...
NodePtr mutateSubtree(NodePtr node, unsigned int maxDepth, const std::vector<std::string>& variables, double mutProb, const std::tuple<double, double, double, double>& probs,
    const UnaryMap& unaryFuncs, const BinaryMap& binaryFuncs, const NaryMap& naryFuncs);
